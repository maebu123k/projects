section .data
	...
	stringLen:  equ $-string                       ; Length of the 'string' string
...
_start:
	...
	mov ecx,string       ; Put the offset of string in ecx
	mov edx,stringLen    ; stringLen is a constant, so we don't need to say
	                     ;  mov edx,[stringLen] to get it's actual value
